...
```ts
{{#include ../listings-ts/inline/ch04-01/snippet-01.ts}}
```
...
```ts
{{#include ../listings-ts/listing-04-01/main.ts}}
```
...
```ts
{{#include ../listings-ts/inline/ch04-01/snippet-02.ts}}
```
...
```ts
{{#include ../listings-ts/no-listing-01-can-mutate-string/main.ts}}
```
...
```ts
{{#include ../listings-ts/no-listing-02-string-scope/main.ts}}
```
...
```ts
{{#include ../listings-ts/listing-04-02/main.ts}}
```
...
```ts
{{#include ../listings-ts/no-listing-03-string-move/main.ts}}
```
...
```ts
{{#include ../listings-ts/no-listing-04-cant-use-after-move/main.ts}}
```
...
```ts
{{#include ../listings-ts/no-listing-05-clone/main.ts}}
```
...
```ts
{{#include ../listings-ts/no-listing-06-copy/main.ts}}
```
...
```ts
{{#include ../listings-ts/listing-04-03/main.ts}}
```
...
```ts
{{#include ../listings-ts/listing-04-04/main.ts}}
```
...
```ts
{{#include ../listings-ts/listing-04-05/main.ts}}
```
