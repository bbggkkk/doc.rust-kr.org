...
```ts
{{#include ../listings-ts/ch19-advanced-features/no-listing-04-kilometers-alias/main_here.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/no-listing-04-kilometers-alias/main_there.ts}}
```
...
```ts
{{#include ../listings-ts/inline/ch19-04/snippet-01.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/listing-19-24/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/listing-19-25/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/no-listing-05-write-trait/lib.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/no-listing-06-result-alias/lib_here.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/no-listing-06-result-alias/lib_there.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/no-listing-07-never-type/lib.ts}}
```
...
```ts
{{#include ../listings-ts/ch02-guessing-game-tutorial/listing-02-05/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/no-listing-08-match-arms-different-types/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/no-listing-09-unwrap-definition/lib.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/no-listing-10-loop-returns-never/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/no-listing-11-cant-create-str/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/no-listing-12-generic-fn-definition/lib.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/no-listing-13-generic-implicit-sized-bound/lib.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/no-listing-14-generic-maybe-sized/lib.ts}}
```
