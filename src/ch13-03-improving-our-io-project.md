...
```ts
{{#include ../listings-ts/ch13-functional-features/listing-12-23-reproduced/src/lib.ts}}
```
...
```ts
{{#include ../listings-ts/ch13-functional-features/listing-12-24-reproduced/src/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch13-functional-features/listing-13-18/src/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch13-functional-features/listing-13-19/src/lib.ts}}
```
...
```ts
{{#include ../listings-ts/ch13-functional-features/listing-13-20/src/lib.ts}}
```
...
```ts
{{#include ../listings-ts/ch13-functional-features/listing-13-22/src/lib.ts}}
```
