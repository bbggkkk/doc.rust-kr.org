...
```javascript
{{#include ../js-examples/ch13-functional-features/listing-13-17.js}}
```
...
```javascript
{{#include ../js-examples/ch13-functional-features/listing-13-18.js}}
```
...
```javascript
{{#include ../js-examples/ch13-functional-features/config-build-iterator.js}}
```
...
```javascript
{{#include ../js-examples/ch13-functional-features/search-iterator.js}}
```
