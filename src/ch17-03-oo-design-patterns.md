...
```ts
{{#include ../listings-ts/ch17-oop/listing-17-11/src/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch17-oop/listing-17-12/src/lib.ts}}
```
...
```ts
{{#include ../listings-ts/ch17-oop/listing-17-13/src/lib.ts}}
```
...
```ts
{{#include ../listings-ts/ch17-oop/listing-17-14/src/lib.ts}}
```
...
```ts
{{#include ../listings-ts/ch17-oop/listing-17-15/src/lib.ts}}
```
...
```ts
{{#include ../listings-ts/ch17-oop/listing-17-16/src/lib.ts}}
```
...
```ts
{{#include ../listings-ts/ch17-oop/listing-17-17/src/lib.ts}}
```
...
```ts
{{#include ../listings-ts/ch17-oop/listing-17-18/src/lib.ts}}
```
...
```ts
{{#include ../listings-ts/inline/ch17-03/snippet-01.ts}}
```
...
```ts
{{#include ../listings-ts/ch17-oop/listing-17-19/src/lib.ts}}
```
...
```ts
{{#include ../listings-ts/ch17-oop/listing-17-20/src/lib.ts}}
```
...
```ts
{{#include ../listings-ts/ch17-oop/listing-17-21/src/main.ts}}
```
