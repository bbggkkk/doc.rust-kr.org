...
```javascript
{{#include ../js-examples/ch08-common-collections/listing-08-11.js}}
```
...
```javascript
{{#include ../js-examples/ch08-common-collections/listing-08-12.js}}
```
...
```javascript
{{#include ../js-examples/ch08-common-collections/listing-08-15.js}}
```
...
```javascript
{{#include ../js-examples/ch08-common-collections/listing-08-17.js}}
```
...
```javascript
{{#include ../js-examples/ch08-common-collections/listing-08-18.js}}
```
...
```javascript
{{#include ../js-examples/ch08-common-collections/no-listing-02-format.js}}
```
...
```javascript
{{#include ../js-examples/ch08-common-collections/chars-iteration.js}}
```
