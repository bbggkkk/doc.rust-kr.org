...
```ts
{{#include ../listings-ts/ch16-fearless-concurrency/listing-16-12/main.ts}}
```
...
```javascript
{{#include ../js-examples/ch16-fearless-concurrency/listing-16-12.js}}
```
...
```ts
{{#include ../listings-ts/ch16-fearless-concurrency/listing-16-13/main.ts}}
```
...
```javascript
{{#include ../js-examples/ch16-fearless-concurrency/listing-16-13.js}}
```
...
```ts
{{#include ../listings-ts/ch16-fearless-concurrency/listing-16-14/main.ts}}
```
...
```javascript
{{#include ../js-examples/ch16-fearless-concurrency/listing-16-14.js}}
```
...
```ts
{{#include ../listings-ts/ch16-fearless-concurrency/listing-16-15/main.ts}}
```
...
```javascript
{{#include ../js-examples/ch16-fearless-concurrency/listing-16-15.js}}
```
