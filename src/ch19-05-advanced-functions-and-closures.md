...
```ts
{{#include ../listings-ts/ch19-advanced-features/listing-19-27/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/no-listing-15-map-closure/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/no-listing-16-map-function/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/no-listing-17-map-initializer/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/no-listing-18-returns-closure/lib.ts}}
```
...
```ts
{{#include ../listings-ts/ch19-advanced-features/no-listing-19-returns-closure-trait-object/lib.ts}}
```
