...
```javascript
{{#include ../js-examples/ch19-advanced-features/listing-19-27.js}}
```
...
```javascript
{{#include ../js-examples/ch19-advanced-features/no-listing-15-map.js}}
```
...
```javascript
{{#include ../js-examples/ch19-advanced-features/no-listing-19-returns-closure.js}}
```
