...
```ts
{{#include ../listings-ts/ch12-an-io-project/listing-12-05/src/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch12-an-io-project/listing-12-06/src/main.ts}}
```
...
```javascript
{{#include ../js-examples/ch12-an-io-project/listing-12-06.js}}
```
...
```ts
{{#include ../listings-ts/ch12-an-io-project/listing-12-07/src/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch12-an-io-project/listing-12-08/src/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch12-an-io-project/listing-12-09/src/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch12-an-io-project/listing-12-10/src/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch12-an-io-project/listing-12-11/src/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch12-an-io-project/listing-12-12/src/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch12-an-io-project/no-listing-01-handling-errors-in-main/src/main.ts}}
```
...
```ts
{{#include ../listings-ts/ch12-an-io-project/listing-12-13/src/lib.ts}}
```
...
```javascript
{{#include ../js-examples/ch12-an-io-project/listing-12-13.js}}
```
...
```ts
{{#include ../listings-ts/ch12-an-io-project/listing-12-14/src/main.ts}}
```
...
```javascript
{{#include ../js-examples/ch12-an-io-project/listing-12-14.js}}
```
